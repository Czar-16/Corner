...
import { signupInput } from "@czar16/common";
...
type SignupFormData = z.infer<typeof signupInput>;
  ...
  return (
    <div className="w-full max-w-md px-4 sm:px-6">
      <div className="rounded-3xl border border-[#2A2A2E] bg-[#161618] p-6 sm:p-8 shadow-[0_0_40px_rgba(201,162,107,0.08)]">
        <div className="mt-12 text-[#F2EFE9]">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            <div>
              <Label className="text-[#9C9891]">Name</Label>
              <Input
                {...register("name")}
            ...
            <Button
              type="submit"
              className="mt-3 w-full bg-[#C9A26B] text-[#121214] hover:bg-[#B58F5C]"
            >
              Create account
            </Button>
